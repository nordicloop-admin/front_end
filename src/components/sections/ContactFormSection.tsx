          ...
          <div className="md:w-1/2 flex items-center self-stretch">
            <div>
              ...
              <p className="text-sm md:text-base text-gray-600 mb-4">
                Our team is ready to answer your questions and help you<br/> discover how Nordic Loop can transform your waste<br/> management approach and reduce your environmental impact.
              </p>
            </div>
          </div>
