...
export default function DashboardLayoutClient({
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* Sidebar */}
      <div className="w-[190px] bg-white border-r border-gray-200 flex flex-col">
        {/* Logo */}
      ...
      <div className="flex-1">
        {/* Header */}
        <header className="bg-white border-b border-gray-200 h-[60px] flex items-center justify-between px-6">
          {/* Search */}
          ...
          <div className="flex items-center space-x-4">
            <button className="bg-[#FF8A00] text-white py-2 px-4 rounded flex items-center">
            ...
            <div className="flex items-center">
              <span className="font-medium mr-2">Hello {user?.firstName || user?.username?.split(' ')[0] || 'User'}</span>
