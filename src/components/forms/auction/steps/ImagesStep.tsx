...
import { Camera, Upload, X, Type, Tag, Info } from 'lucide-react';
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Upload an image and create an attractive title and description for your listing
        </p>
      </div>
      ...
      {(!formData.images || formData.images.length === 0 || !formData.title || !formData.description) && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
          <p className="text-sm text-yellow-600">
            Please provide an image, title, and description for your listing.
          </p>
        </div>
      )}
    </div>
